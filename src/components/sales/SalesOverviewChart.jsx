	...
	return (
		...
		>
			<div className='flex items-center justify-between mb-6'>
				<h2 className='text-xl font-semibold text-cyan-100'>Sales Overview</h2>

				<select
					className='bg-cyan-700 text-white rounded-md px-3 py-1 focus:outline-none focus:ring-2 
          focus:ring-blue-500
          '
