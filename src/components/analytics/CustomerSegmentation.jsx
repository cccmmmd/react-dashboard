...
const CustomerSegmentation = () => {
	return (
		<motion.div
			className='bg-cyan-800 bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6 border border-cyan-700'
			initial={{ opacity: 0, y: 20 }}
			animate={{ opacity: 1, y: 0 }}
			transition={{ delay: 0.6 }}
		>
			<h2 className='text-xl font-semibold text-cyan-100 mb-4'>Customer Segmentation</h2>
