	...
	return (
		...
		>
			<div className='flex justify-between items-center mb-6'>
				<h2 className='text-xl font-semibold text-cyan-100'>Order List</h2>
			...
			<div className='overflow-x-auto'>
				<table className='min-w-full divide-y divide-cyan-700'>
					...
					<tbody className='divide divide-cyan-700'>
						{filteredOrders.map((order) => (
							...
							>
								...
								<td className='px-6 py-4 whitespace-nowrap text-sm text-cyan-300'>{order.date}</td>
								<td className='px-6 py-4 whitespace-nowrap text-sm text-cyan-300'>
